CLASS zcl_probar_calc_aad DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_probar_calc_aad IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

"si no sale buscar en las clases del profesor que acaban en "_25".

    DATA(lo_calculadora) = NEW zcl_calculadora_25( ).
...
*    out->write( lo_calculadora->dividir( num1 = 100 num2 = 0 ) ).
    ...
    CATCH zcx_resultado_novalido_aad into data(lo_excepcion2).
...
*    IF sy-subrc = 0.
*
**      " Leemos de la tabla interna --> FORMA TRADICIONAL. EL SY-SUBRC NO SIRVE CON LA DECLARACION MODERNA.
